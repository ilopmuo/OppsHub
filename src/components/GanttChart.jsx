...
export default function GanttChart({
  ...
  return (
    <div className="flex flex-col" style={{ height: compact ? 'auto' : '100%' }}>
      ...
      >
        <div style={{ minWidth: LABEL_W + canvasW, position: 'relative' }}>
          ...
          >
            ...
            <div style={{ width: LABEL_W, minWidth: LABEL_W, borderRight: '1px solid rgba(255,255,255,0.06)' }} />
            {/* Month cells */}
